...
/**
 * <p>Java class for indexterm.class complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="indexterm.class">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;group ref="{}indexterm.content"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{}indexterm.attributes"/>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "indexterm.class", propOrder = {
    "content"
})
@XmlSeeAlso({
    Indexterm.class
})
public class IndextermClass extends GenericData {

    @XmlElementRefs({
        @XmlElementRef(name = "index-see", type = IndexSee.class, required = false),
        @XmlElementRef(name = "term", type = Term.class, required = false),
        @XmlElementRef(name = "unknown", type = Unknown.class, required = false),
        @XmlElementRef(name = "index-sort-as", type = IndexSortAs.class, required = false),
        @XmlElementRef(name = "index-see-also", type = IndexSeeAlso.class, required = false),
        ...
        @XmlElementRef(name = "index-base", type = IndexBase.class, required = false),
