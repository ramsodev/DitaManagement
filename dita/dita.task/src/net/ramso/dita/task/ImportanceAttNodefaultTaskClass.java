...
/**
 * <p>Java class for importance-att-nodefault-task.class.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="importance-att-nodefault-task.class">
 ...
 * 
 */
@XmlType(name = "importance-att-nodefault-task.class")
@XmlEnum(ImportanceAttsClass.class)
public enum ImportanceAttNodefaultTaskClass {
    ...
    ImportanceAttNodefaultTaskClass(ImportanceAttsClass v) {
        value = v;
    }
    ...
    public static ImportanceAttNodefaultTaskClass fromValue(ImportanceAttsClass v) {
        for (ImportanceAttNodefaultTaskClass c: ImportanceAttNodefaultTaskClass.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
